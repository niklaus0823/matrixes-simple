...
interface IMemSet {
  path: string; // "/com.memcached.MemcachedService/MemSet"
...
interface IMemSetMulti {
  path: string; // "/com.memcached.MemcachedService/MemSetMulti"
  requestStream: boolean; // false
  responseStream: boolean; // false
...
interface IMemAdd {
  path: string; // "/com.memcached.MemcachedService/MemAdd"
  requestStream: boolean; // false
  responseStream: boolean; // false
...
interface IMemDel {
  path: string; // "/com.memcached.MemcachedService/MemDel"
  requestStream: boolean; // false
  responseStream: boolean; // false
...
interface IMemGet {
  path: string; // "/com.memcached.MemcachedService/MemGet"
  requestStream: boolean; // false
  responseStream: boolean; // false
...
interface IMemGetMulti {
  path: string; // "/com.memcached.MemcachedService/MemGetMulti"
  requestStream: boolean; // false
  responseStream: boolean; // false
