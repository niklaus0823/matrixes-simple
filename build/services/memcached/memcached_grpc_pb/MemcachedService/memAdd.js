...
exports.memAddHandler = (ctx, next) => __awaiter(this, void 0, void 0, function* () {
    let call = ctx.call;
    ...
    try {
        yield ctx.validate(request, {
            ...
            value: matrixes_lib_1.joiType.vString.activate(),
            lifeTime: matrixes_lib_1.joiType.vUint64.activate(),
        });
